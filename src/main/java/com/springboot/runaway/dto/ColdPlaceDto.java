...
@Schema(description = "한파쉼터 정보 DTO")
public class ColdPlaceDto {
    ...
    public ColdPlaceDto(String dongNm, String fcltNm, String addr, String capacity, String wdUtztnHrm, double longitude, double latitude, double distance) {
        this.dongNm = dongNm;
        this.fcltNm = fcltNm;
        this.addr = addr;

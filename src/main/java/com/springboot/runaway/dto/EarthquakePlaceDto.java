...
public class EarthquakePlaceDto {
    ...
    public EarthquakePlaceDto(String dongNm, String fcltNm, String addr, String fcltType,
                              String utztnPsbltyNope, String wdUtztnHrm,
                              double xcrd, double ycrd, double distance) {
        this.dongNm = dongNm;
        this.fcltNm = fcltNm;
        this.addr = addr;
